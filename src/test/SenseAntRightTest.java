...
public class SenseAntRightTest {
    @Test
    public void SenseFriendFoeTest() {
        ...
        brainA[0] = new SenseAnt("right", Target.friend, 2);
        brainA[1] = new Jump(1);
        brainA[1] = new Jump(1);
    ...
    public void SenseFriendFoe1Test() {
        ...
        Ant antA0 = new Ant(swarmA, 0, field00);
        Ant antA1 = new Ant(swarmA, 0, field01);
        field00.setAnt(antA0);
    ...
    public void SenseFriendFoe2Test() {
        ...
        Instruction[] brainA = new Instruction[2];
        brainA[0] = new SenseAnt("right", Target.foe, 2);
        brainA[1] = new Jump(1);
        brainA[1] = new Jump(1);
        Instruction[] brainB = new Instruction[2];
        brainB[0] = new Jump(0);
    ...
    public void SenseFriendFoe3Test() {
        ...
        Ant antA0 = new Ant(swarmA, 0, field00);
        Ant antB0 = new Ant(swarmB, 0, field01);
        field00.setAnt(antA0);
        field01.setAnt(antB0);
