...
public class SenseFoodLeftTest {
    @Test
    public void SenseFoodTest() {
        ...
        brainA[0] = new SenseFood("left", Target.food, 2);
        brainA[1] = new Jump(1);
        brainA[1] = new Jump(1);
    ...
    public void SenseFoodTest2() {
        ...
        Instruction[] brainA = new Instruction[2];
        brainA[0] = new SenseFood("left", Target.friendfood, 2);
        brainA[1] = new Jump(1);
        brainA[1] = new Jump(1);
        Instruction[] brainB = new Instruction[2];
        brainB[0] = new Jump(0);
    ...
    public void SenseFoodTest4() {
        ...
        Instruction[] brainA = new Instruction[2];
        brainA[0] = new SenseFood("left", Target.foefood, 2);
        brainA[1] = new Jump(1);
        brainA[1] = new Jump(1);
        Instruction[] brainB = new Instruction[2];
        brainB[0] = new Jump(0);
        ...
        Ant antA0 = new Ant(swarmA, 0, field00);
        field00.setAnt(antA0);
        Ant antB1 = new Ant(swarmB,1,field10);
        antB1.setHasFood(true);
        field10.setAnt(antB1);
        HashMap<Integer, Ant> ants = new HashMap<>();
        ants.put(0, antA0);
        ants.put(1,antB1);
