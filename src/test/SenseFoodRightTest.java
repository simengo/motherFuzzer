...
public class SenseFoodRightTest {
    @Test
    public void SenseFoodTest() {
        ...
        brainA[0] = new SenseFood("right", Target.food, 2);
        brainA[1] = new Jump(1);
        brainA[1] = new Jump(1);
    ...
    public void SenseFoodTest2() {
        ...
        Instruction[] brainA = new Instruction[2];
        brainA[0] = new SenseFood("right", Target.friendfood, 2);
        brainA[1] = new Jump(1);
        brainA[1] = new Jump(1);
        Instruction[] brainB = new Instruction[2];
        brainB[0] = new Jump(0);
    ...
    public void SenseFoodTest4() {
        ...
        Instruction[] brainA = new Instruction[2];
        brainA[0] = new SenseFood("right", Target.foefood, 2);
        brainA[1] = new Jump(1);
        brainA[1] = new Jump(1);
        Instruction[] brainB = new Instruction[2];
        brainB[0] = new Jump(0);
