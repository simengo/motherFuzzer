...
public class BreedGoesWrong {
    @Test
    public void BreedAntlionGoesHorriblyWrong() {
        ...
        Ant antTest = new Ant(swarmA, 7, spielfeld[2][2]);
        ...
        antTest.setField(spielfeld[2][2]);
