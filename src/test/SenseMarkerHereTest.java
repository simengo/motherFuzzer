...
public class SenseMarkerHereTest {
    ...
    public void SenseFoeMarkerTest() {
        ...
        Instruction[] brainA = new Instruction[2];
        brainA[0] = new SenseMarker("here", Target.foemarker, 0, 2);
        brainA[1] = new Jump(1);
        brainA[1] = new Jump(1);
        Instruction[] brainB = new Instruction[2];
        brainB[0] = new Jump(0);
    ...
    public void SenseFoeMarkerTest2() {
        ...
        Instruction[] brainA = new Instruction[2];
        brainA[0] = new SenseMarker("here", Target.foemarker, 1, 2);
        brainA[1] = new Jump(1);
        brainA[1] = new Jump(1);
        Instruction[] brainB = new Instruction[2];
        brainB[0] = new Jump(0);
    ...
    public void SenseFoeMarkerTest4() {
        ...
        Instruction[] brainA = new Instruction[2];
        brainA[0] = new SenseMarker("here", Target.foemarker, 2, 2);
        brainA[1] = new Jump(1);
        brainA[1] = new Jump(1);
        Instruction[] brainB = new Instruction[2];
        brainB[0] = new Jump(0);
    ...
    public void SenseFoeMarkerTest6() {
        ...
        Instruction[] brainA = new Instruction[2];
        brainA[0] = new SenseMarker("here", Target.foemarker, 3, 2);
        brainA[1] = new Jump(1);
        brainA[1] = new Jump(1);
        Instruction[] brainB = new Instruction[2];
        brainB[0] = new Jump(0);
    ...
    public void SenseFoeMarkerTest8() {
        ...
        Instruction[] brainA = new Instruction[2];
        brainA[0] = new SenseMarker("here", Target.foemarker, 4, 2);
        brainA[1] = new Jump(1);
        brainA[1] = new Jump(1);
        Instruction[] brainB = new Instruction[2];
        brainB[0] = new Jump(0);
    ...
    public void SenseFoeMarkerTest10() {
        ...
        Instruction[] brainA = new Instruction[2];
        brainA[0] = new SenseMarker("here", Target.foemarker, 5, 2);
        brainA[1] = new Jump(1);
        brainA[1] = new Jump(1);
        Instruction[] brainB = new Instruction[2];
        brainB[0] = new Jump(0);
    ...
    public void SenseFoeMarkerTest12() {
        ...
        Instruction[] brainA = new Instruction[2];
        brainA[0] = new SenseMarker("here", Target.foemarker, 6, 2);
        brainA[1] = new Jump(1);
        brainA[1] = new Jump(1);
        Instruction[] brainB = new Instruction[2];
        brainB[0] = new Jump(0);
